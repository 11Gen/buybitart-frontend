...
const GalleryCard = ({ data }) => {
  return (
    <Link to={`/gallery/${data.hash}`} className="2xl:w-[390px] xl:w-[346px] w-full h-max flex flex-col gap-4 group">
      <img
        src={data.images[0]}
        alt={data.title}
      ...
      <div className="flex items-center w-full h-auto relative justify-between">
        ...
        <button className="w-[33px] h-[33px] rounded-full group-hover:bg-[#fff] transition-colors duration-300">
          <svg
            width="33"
            height="33"
            viewBox="0 0 33 33"
