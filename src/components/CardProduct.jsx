    ...
    <>
      <div className="w-full h-full rounded-xl p-3.5 relative overflow-hidden border-[1px] border-[#FFFFFF1A] hover:bg-[#ffffff10] transition-colors duration-300 flex flex-col justify-between gap-3 bg-[#00000027] backdrop-blur-3xl">
        ...
        >
          {auction ? (
            <>
              <div className="w-[28px] h-[28px] absolute bg-[#0000003d] flex items-center backdrop-blur-xl justify-center z-[2] left-2.5 top-2.5 rounded-xl p-1 border-[1px] border-[#ffffff1A]">
                <svg
                  width="24"
                  height="25"
                  viewBox="0 0 24 25"
                  ...
                  className={`invert brightness-0 transition duration-[250ms]`}
                >
                  <path
