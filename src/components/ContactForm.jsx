...
const ContactForm = ({ decor }) => {
  ...
  //    min-h-[284px]
  return (
    <div className={`w-full h-auto min-h-[464px] ${decor ? 'my-14 md:my-0' : 'my-5 md:my-0'} relative flex justify-center items-center`}>
      <div className="w-full max-w-[85vw] z-[1] h-auto rounded-[20px] p-4 sm:p-8 bg-[#ffffff]/10 backdrop-blur-xl xl:flex-row flex-col flex justify-between">
      ...
      {decor && (
        <>
          ...
          <div className="w-[405px] xl:w-[505px] h-[300px] xl:h-[400px] absolute bottom-[-150px] right-[-300px] bg-[#FFE2002E] rounded-full blur-[150px] rotate-[22deg] pointer-events-none"></div>
          <div className="w-[300px] xl:w-[400px] h-[300px] xl:h-[400px] absolute top-[-156px] left-[-183px] bg-[#FFE2002E] rounded-full blur-[150px] rotate-[22deg] pointer-events-none"></div>
        </>
      )}
    </div>
  );
